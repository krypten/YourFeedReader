...
public class DrawInsetsFrameLayout extends FrameLayout {
	...
	public DrawInsetsFrameLayout(final Context context) {
		super(context);
		init(context, null, 0);
	}

	public DrawInsetsFrameLayout(final Context context, final AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs, 0);
	}

	public DrawInsetsFrameLayout(final Context context, final AttributeSet attrs, final int defStyle) {
	...
	public void setInsetBackground(final Drawable insetBackground) {
	...
	public interface OnInsetsCallback {
		void onInsetsChanged(final Rect insets);
	}
}
